function fish_prompt
	...
	__sf_util_set_default SPACEFISH_PROMPT_DEFAULT_PREFIX " "
	__sf_util_set_default SPACEFISH_PROMPT_DEFAULT_SUFFIX " "
	__sf_util_set_default SPACEFISH_PROMPT_ORDER time user dir host git package node ruby golang php rust haskell julia elixir docker aws venv conda pyenv dotnet kubecontext exec_time line_sep vi_mode jobs exit_code char
	...
	if test "$SPACEFISH_PROMPT_ADD_NEWLINE" = "false"
		echo
	end
